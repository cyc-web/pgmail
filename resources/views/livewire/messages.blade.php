            ...
            <table id="" class="table">
                ...
                @if($user->message_status == 1)
                 <tr style="background-color: rgb(235, 230, 230);">
                  ...
                  <td><a href="/read/{{$user->id}}" style="text-decoration: none; color:black">{{$user->owner}}</a></td>
                  <td><a href="/read/{{$user->id}}" style="text-decoration: none; color:black">{{substr($user->subject, 0, 100)}}</a></td>
                ...
                <tr>
                  ...
                  <td><a href="/read/{{$user->id}}" style="text-decoration: none;">{{$user->owner}}</a></td>
                  <td><a href="/read/{{$user->id}}" style="text-decoration: none;">{{substr($user->subject, 0, 100)}}</a></td>
                  <td class="text-center"><i class="fa fa-archive" wire:click='archive({{$user->id}})' style="cursor: pointer;"></i>&nbsp; &nbsp;&nbsp; &nbsp; <i class="fa fa-trash text-danger" wire:click="remove({{$user->id}})" style="cursor: pointer;"></i> </td>
                </tr>
                @endif
                @endforeach
